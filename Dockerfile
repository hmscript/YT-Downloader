...
# Install wgcf (generates WARP credentials)
RUN curl -fsSL https://github.com/ViRb3/wgcf/releases/download/v2.0.12/wgcf_2.0.12_linux_amd64 \
...
# Configure Squid to expose WARP as HTTP proxy on port 8080
